...
require 'net/http'
#=> true
data = {"shipments"=>[{"name"=>"Williams", "order"=>"REFNUM67855", "products_desc"=>"Order Description", "order_date"=>"2014-04-24 18:43:01 +0530", "payment_mode"=>"Cash", "total_amount"=>500, "cod_amount"=>500, "add"=>"1st Floor,plot no 82,sector 44,Gurgaon(HARYANA) 200332", "city"=>"Gurgaon", "state"=>"Gurgaon", "country"=>"india", "phone"=>"9145345544", "pin"=>"400064","product_quantity"=> 1,"invoice_number"=> "invoice number","invoice_date"=> "2014-04-24 18:43:01 +0530"}], "pickup_location"=>{"add"=>"Vendor address, area, city,pincode", "city"=>"Gurgaon", "country"=>"India", "name"=>"warehouse_name", "phone"=>"0141-2353333 ", "pin"=>"343243", "state"=>"Maharashtra"},"seller"=> {"name"=> "registered name of the seller","add"=> ["address line 1", "address line 2", "city / state, pin"],"cst"=>"cst number", "tin"=>"tin number"}}
