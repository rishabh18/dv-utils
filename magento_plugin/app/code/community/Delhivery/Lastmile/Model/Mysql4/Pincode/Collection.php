 ...
 * @purpose    Define Mysql collection for pincode 
 */
class Delhivery_Lastmile_Model_Mysql4_Pincode_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
